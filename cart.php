                    ...
                    <table class="table">
                        ...
                        <tbody>
                          <?php if($cart_price->all_price > 0) : ?>
                            ...
                            <tr>
                              <th><img src="images/<?php echo $cart_item->image;?>" style="width:50px; height:50px"></th>
                              <td><?php echo $cart_item->name;?></td>
                              <td>LKR <?php echo $cart_item->price;?></td>
                              <td><a href="<?php echo APPURL; ?>/deleteitem.php?id=<?php echo $cart_item->id; ?>"class="btn btn-danger text-white">delete</td>
                            </tr>
                            <?php endforeach; ?>
                          <?php else : ?>
